...
namespace MvcMusicStore.Models
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MusicStoreEntities>
    {
        protected override void Seed(MusicStoreEntities context)
        {
          ...
          //  RegisterUser user = new RegisterUser { UserName = "Administrator", Email = "Admin@Admin.com", Password = "password123!", ConfirmPassword = "password123!" };
           // RegisterUser user1 = new RegisterUser { UserName = "Medhat", Email = "medhat@mail.com", Password = "password123!", ConfirmPassword = "password123!" };
